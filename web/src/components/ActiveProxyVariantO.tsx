...
export default function ActiveProxyVariantO({
      ...
      <Card>
        <CardBody className="p-4">
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span className="font-medium">Variant O — Active Proxy</span>
      ...
      <CardBody className="p-4 space-y-3">
        ...
        <div className="flex items-center gap-3 text-xs px-3 py-2.5 rounded-lg bg-gray-50 dark:bg-gray-800/50">
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span className="font-semibold text-sm text-gray-700 dark:text-gray-200">Variant O</span>
          </div>
