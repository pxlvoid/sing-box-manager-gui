...
| `pending_nodes` | array | Ноды в статусе pending (ожидают верификации) |
| `verified_nodes` | array | Ноды в статусе verified (прошли проверку) |
| `archived_nodes` | array | Ноды в статусе archived (заархивированы после N провалов) |
